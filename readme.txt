...
Dev Starter WordPress Theme, Copyright 2019-2023 WordPress.org
Dev Starter is distributed under the terms of the GNU GPL.
...
Dev Starter is derived from the Chaplin Theme, Copyright 2019 Anders Norén
Chaplin Theme is distributed under the terms of the GNU GPL version 2.0

Dev Starter bundles the following third-party resources:
...
Bespoke Icons Created For Dev Starter
License: Creative Commons Zero (CC0), https://creativecommons.org/publicdomain/zero/1.0/
...
- DevStarter_SVG_Icons
- devstarter_the_theme_svg()
- devstarter_get_theme_svg()
- devstarter_nav_menu_social_icons()
